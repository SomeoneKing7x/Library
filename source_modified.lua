...
local someonelib = {
    ...
    -- Para substituir por uma imagem, use um ImageLabel com um AssetID
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
    ...
    ["Color Hub 1"] = ColorSequence.new({
    -- Para substituir por uma imagem, use um ImageLabel com um AssetID
    imagem.Image = "rbxassetid://127950462202673"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), -- Preto
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 64, 0)), -- Verde escuro
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0)) -- Preto
    }),
    ["Color Hub 2"] = Color3.fromRGB(0, 0, 0), -- Preto
    ["Color Stroke"] = Color3.fromRGB(0, 50, 0), -- Verde escuro
    ["Color Theme"] = Color3.fromRGB(0, 255, 0), -- Verde brilhante
    ["Color Text"] = Color3.fromRGB(200, 255, 200), -- Verde claro para texto
    ["Color Dark Text"] = Color3.fromRGB(100, 200, 100) -- Verde médio para texto
},
Cinza = {
    ["Color Hub 1"] = ColorSequence.new({
    -- Para substituir por uma imagem, use um ImageLabel com um AssetID
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), -- Preto
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(200, 200, 200)), -- Cinza claro
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0)) -- Preto
    }),
    ["Color Hub 2"] = Color3.fromRGB(255, 255, 255), -- Branco
    ["Color Stroke"] = Color3.fromRGB(0, 0, 0), -- Preto
    ["Color Theme"] = Color3.fromRGB(255, 255, 255), -- Branco
    ["Color Text"] = Color3.fromRGB(0, 0, 0), -- Preto para texto
    ["Color Dark Text"] = Color3.fromRGB(150, 150, 150) -- Cinza médio para texto
},
Vermelho = {
    ["Color Hub 1"] = ColorSequence.new({
    -- Para substituir por uma imagem, use um ImageLabel com um AssetID
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), -- Preto
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(139, 0, 0)), -- Vermelho escuro
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0)) -- Preto
    }),
    ["Color Hub 2"] = Color3.fromRGB(139, 0, 0), -- Vermelho escuro
    ["Color Stroke"] = Color3.fromRGB(255, 0, 0), -- Vermelho brilhante
    ["Color Theme"] = Color3.fromRGB(255, 69, 0), -- Vermelho alaranjado
    ["Color Text"] = Color3.fromRGB(255, 255, 255), -- Branco para texto
    ["Color Dark Text"] = Color3.fromRGB(200, 0, 0) -- Vermelho claro para texto
},
Amarelo = {
    ["Color Hub 1"] = ColorSequence.new({
    -- Para substituir por uma imagem, use um ImageLabel com um AssetID
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), -- Preto
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 204, 0)), -- Amarelo escuro
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0)) -- Preto
    }),
    ["Color Hub 2"] = Color3.fromRGB(255, 204, 0), -- Amarelo escuro
    ["Color Stroke"] = Color3.fromRGB(255, 255, 0), -- Amarelo brilhante
    ["Color Theme"] = Color3.fromRGB(255, 221, 51), -- Amarelo alaranjado
    ["Color Text"] = Color3.fromRGB(0, 0, 0), -- Preto para texto
    ["Color Dark Text"] = Color3.fromRGB(153, 153, 0) -- Amarelo médio para texto
},
Rosa = {
    ["Color Hub 1"] = ColorSequence.new({
    -- Para substituir por uma imagem, use um ImageLabel com um AssetID
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), -- Preto
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 105, 180)), -- Rosa escuro
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0)) -- Preto
    }),
    ["Color Hub 2"] = Color3.fromRGB(255, 105, 180), -- Rosa escuro
    ["Color Stroke"] = Color3.fromRGB(255, 20, 147), -- Rosa brilhante
    ["Color Theme"] = Color3.fromRGB(255, 182, 193), -- Rosa claro
    ["Color Text"] = Color3.fromRGB(255, 255, 255), -- Branco para texto
    ["Color Dark Text"] = Color3.fromRGB(255, 192, 203) -- Rosa claro para texto
},
Azul = {
    ["Color Hub 1"] = ColorSequence.new({
    -- Para substituir por uma imagem, use um ImageLabel com um AssetID
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), -- Preto
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 0, 255)), -- Azul escuro
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0)) -- Preto
    }),
    ["Color Hub 2"] = Color3.fromRGB(0, 0, 255), -- Azul escuro
    ["Color Stroke"] = Color3.fromRGB(0, 191, 255), -- Azul claro
    ["Color Theme"] = Color3.fromRGB(70, 130, 180), -- Azul aço
    ["Color Text"] = Color3.fromRGB(255, 255, 255), -- Branco para texto
    ["Color Dark Text"] = Color3.fromRGB(176, 224, 230) -- Azul claro para texto
},
DiaPai = {
    ["Color Hub 1"] = ColorSequence.new({
    -- Para substituir por uma imagem, use um ImageLabel com um AssetID
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), -- Preto
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(70, 130, 180)), -- Azul aço
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0)) -- Preto
    }),
    ["Color Hub 2"] = Color3.fromRGB(70, 130, 180), -- Azul aço
    ["Color Stroke"] = Color3.fromRGB(255, 215, 0), -- Dourado
    ["Color Theme"] = Color3.fromRGB(255, 223, 186), -- Bege suave
    ["Color Text"] = Color3.fromRGB(255, 255, 255), -- Branco para texto
    ["Color Dark Text"] = Color3.fromRGB(169, 169, 169) -- Cinza escuro para texto
},
DiaMae = {
    ["Color Hub 1"] = ColorSequence.new({
    -- Para substituir por uma imagem, use um ImageLabel com um AssetID
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)), -- Branco
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 182, 193)), -- Rosa claro
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 255)) -- Branco
    }),
    ["Color Hub 2"] = Color3.fromRGB(255, 182, 193), -- Rosa claro
    ["Color Stroke"] = Color3.fromRGB(221, 160, 221), -- Lilás suave
    ["Color Theme"] = Color3.fromRGB(255, 105, 180), -- Rosa vibrante
    ["Color Text"] = Color3.fromRGB(0, 0, 0), -- Preto para texto
    ["Color Dark Text"] = Color3.fromRGB(128, 0, 128) -- Roxo escuro para texto
},
DiaKids = {
    ["Color Hub 1"] = ColorSequence.new({
    -- Para substituir por uma imagem, use um ImageLabel com um AssetID
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)), -- Branco
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 223, 0)), -- Amarelo vibrante
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 255)) -- Branco
    }),
    ["Color Hub 2"] = Color3.fromRGB(0, 255, 0), -- Verde brilhante
    ["Color Stroke"] = Color3.fromRGB(255, 69, 0), -- Laranja brilhante
    ["Color Theme"] = Color3.fromRGB(0, 191, 255), -- Azul claro
    ["Color Text"] = Color3.fromRGB(0, 0, 0), -- Preto para texto
    ["Color Dark Text"] = Color3.fromRGB(255, 165, 0) -- Laranja escuro para texto
},
Natal = {
    ["Color Hub 1"] = ColorSequence.new({
    -- Para substituir por uma imagem, use um ImageLabel com um AssetID
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), -- Preto
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 0, 0)), -- Vermelho
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0)) -- Preto
    }),
    ["Color Hub 2"] = Color3.fromRGB(0, 128, 0), -- Verde escuro
    ["Color Stroke"] = Color3.fromRGB(255, 215, 0), -- Dourado
    ["Color Theme"] = Color3.fromRGB(255, 0, 0), -- Vermelho brilhante
    ["Color Text"] = Color3.fromRGB(255, 255, 255), -- Branco para texto
    ["Color Dark Text"] = Color3.fromRGB(169, 169, 169) -- Cinza escuro para texto
},
Valentine = {
    ...
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)), -- Branco
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 105, 180)), -- Rosa claro
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 255)) -- Branco
    }),
    ["Color Hub 2"] = Color3.fromRGB(255, 105, 180), -- Rosa claro
    ["Color Stroke"] = Color3.fromRGB(255, 20, 147), -- Rosa vibrante
    ["Color Theme"] = Color3.fromRGB(255, 0, 0), -- Vermelho brilhante
    ["Color Text"] = Color3.fromRGB(255, 255, 255), -- Branco para texto
    ["Color Dark Text"] = Color3.fromRGB(138, 43, 226) -- Roxo escuro para texto
},
Halloween = {
    ["Color Hub 1"] = ColorSequence.new({
    -- Para substituir por uma imagem, use um ImageLabel com um AssetID
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), -- Preto
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 165, 0)), -- Laranja
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0)) -- Preto
    }),
    ["Color Hub 2"] = Color3.fromRGB(128, 0, 128), -- Roxo escuro
    ["Color Stroke"] = Color3.fromRGB(255, 140, 0), -- Laranja brilhante
    ["Color Theme"] = Color3.fromRGB(255, 69, 0), -- Laranja avermelhado
    ["Color Text"] = Color3.fromRGB(255, 255, 255), -- Branco para texto
    ["Color Dark Text"] = Color3.fromRGB(105, 105, 105) -- Cinza escuro para texto
},
SaoJao = {
    ["Color Hub 1"] = ColorSequence.new({
    -- Para substituir por uma imagem, use um ImageLabel com um AssetID
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)), -- Branco
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 215, 0)), -- Amarelo vibrante
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 255)) -- Branco
    }),
    ["Color Hub 2"] = Color3.fromRGB(0, 0, 255), -- Azul brilhante
    ["Color Stroke"] = Color3.fromRGB(255, 0, 0), -- Vermelho vibrante
    ["Color Theme"] = Color3.fromRGB(255, 140, 0), -- Laranja
    ["Color Text"] = Color3.fromRGB(0, 0, 0), -- Preto para texto
    ["Color Dark Text"] = Color3.fromRGB(169, 169, 169) -- Cinza escuro para texto
},
Carnaval = {
    ...
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)), -- Branco
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 0, 255)), -- Rosa vibrante
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 255)) -- Branco
    }),
    ["Color Hub 2"] = Color3.fromRGB(0, 255, 0), -- Verde limão
    ["Color Stroke"] = Color3.fromRGB(255, 215, 0), -- Amarelo brilhante
    ["Color Theme"] = Color3.fromRGB(0, 0, 255), -- Azul vibrante
    ["Color Text"] = Color3.fromRGB(0, 0, 0), -- Preto para texto
    ["Color Dark Text"] = Color3.fromRGB(255, 165, 0) -- Laranja
},
Pascoa = {
    ["Color Hub 1"] = ColorSequence.new({
    -- Para substituir por uma imagem, use um ImageLabel com um AssetID
    ...
    ["Color Stroke"] = Color3.fromRGB(255, 218, 185), -- Bege suave
    ["Color Theme"] = Color3.fromRGB(255, 240, 245), -- Rosa claro pastel
    ["Color Text"] = Color3.fromRGB(0, 0, 0), -- Preto para texto
    ["Color Dark Text"] = Color3.fromRGB(128, 128, 128) -- Cinza suave
},
AnoNovo = {
    ["Color Hub 1"] = ColorSequence.new({
    -- Para substituir por uma imagem, use um ImageLabel com um AssetID
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)), -- Branco
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 191, 255)), -- Azul claro
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 255)) -- Branco
    }),
    ["Color Hub 2"] = Color3.fromRGB(255, 223, 0), -- Amarelo dourado
    ["Color Stroke"] = Color3.fromRGB(192, 192, 192), -- Prata
    ["Color Theme"] = Color3.fromRGB(255, 223, 0), -- Dourado brilhante
    ["Color Text"] = Color3.fromRGB(0, 0, 0), -- Preto para texto
    ["Color Dark Text"] = Color3.fromRGB(169, 169, 169) -- Cinza escuro
},
DiaInternacionalDaMulher = {
    ...
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)), -- Branco
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(138, 43, 226)), -- Roxo
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 255)) -- Branco
    }),
    ["Color Hub 2"] = Color3.fromRGB(0, 255, 0), -- Verde vibrante
    ["Color Stroke"] = Color3.fromRGB(255, 105, 180), -- Rosa vibrante
    ["Color Theme"] = Color3.fromRGB(138, 43, 226), -- Roxo forte
    ["Color Text"] = Color3.fromRGB(255, 255, 255), -- Branco para texto
    ["Color Dark Text"] = Color3.fromRGB(128, 0, 128) -- Roxo escuro
},
EspacoSideral = {
    ["Color Hub 1"] = ColorSequence.new({
    -- Para substituir por uma imagem, use um ImageLabel com um AssetID
    -- Exemplo: imagem.Image = "rbxassetid://SEU_ASSET_ID_AQUI"
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), -- Preto (espaço profundo)
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(25, 25, 112)), -- Azul escuro (céu noturno)
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(75, 0, 130)) -- Roxo escuro (galáxias)
    }),
    ["Color Hub 2"] = Color3.fromRGB(75, 0, 130), -- Roxo escuro
    ["Color Stroke"] = Color3.fromRGB(255, 255, 255), -- Branco (estrelas)
    ["Color Theme"] = Color3.fromRGB(169, 169, 169), -- Prata (misterioso)
    ["Color Text"] = Color3.fromRGB(255, 255, 255), -- Branco para texto
    ["Color Dark Text"] = Color3.fromRGB(169, 169, 169) -- Prata claro para texto
}
	},
	Info = {
		Version = "1.1.0"
	...
	Save = {
		UISize = {650, 420},
		TabSize = 160,
		Theme = "Verde"--Darker, Dark, Purple, Verde, Cinza, Vermelho, Amarelo, Rosa, Azul, DiaPai, DiaMae, DiaKids, Natal, Valentine, Halloween, SaoJao, Carnaval, Pascoa, AnoNovo, DiaInternacionalMulher, EspacoSideral
	},
	Settings = {},
	Connection = {},
	Instances = {},
	...
	Icons = (function()
	  -- This file was @generated by Tarmac. It is not intended for manual editing.
		return {
		    ["Hub"] = "rbxassetid://127950462202673",
...
local Settings = someonelib.Settings
local Flags = someonelib.Flags

local SetProps, SetChildren, InsertTheme, Create do
	InsertTheme = function(Instance, Type)
		table.insert(someonelib.Instances, {
			Instance = Instance,
			Type = Type
		})
		return Instance
	...
	local function Save(file)
		if readfile and isfile and isfile(file) then
			...
			if type(decode) == "table" then
				if rawget(decode, "UISize") then someonelib.Save["UISize"] = decode["UISize"] end
				if rawget(decode, "TabSize") then someonelib.Save["TabSize"] = decode["TabSize"] end
				if rawget(decode, "Theme") and VerifyTheme(decode["Theme"]) then someonelib.Save["Theme"] = decode["Theme"] end
			end
		end
	end
	
	pcall(Save, "SettingsLibrary.json")
end
...
local Connections, Connection = {}, someonelib.Connection do
...
local function VerifyTheme(Theme)
	for name,_ in pairs(someonelib.Themes) do
		if name == Theme then
			return true
		end
	end
...
local Theme = someonelib.Themes[someonelib.Save.Theme]

local function AddEle(Name, Func)
	someonelib.Elements[Name] = Func
end

local function Make(Ele, Instance, props, ...)
	local Element = someonelib.Elements[Ele](Instance, props, ...)
	return Element
end
...
-- /////////// --
function someonelib:GetIcon(index)
...
function someonelib:SetTheme(NewTheme)
	if not VerifyTheme(NewTheme) then return end
	
	someonelib.Save.Theme = NewTheme
	SaveJson("Someone Library.json", someonelib.Save)
	Theme = someonelib.Themes[NewTheme]
	
	Comnection:FireConnection("ThemeChanged", NewTheme)
	table.foreach(someonelib.Instances, function(_,Val)
...
function someonelib:SetScale(NewScale)
	NewScale = ViewportSize.Y / math.clamp(NewScale, 300, 2000)
	UIScale, ScreenGui.Scale.Scale = NewScale, NewScale
end

function someonelib:MakeWindow(Configs)
	local WTitle = Configs[1] or Configs.Name or Configs.Title or "Someone Library"
	local WMiniText = Configs[2] or Configs.SubTitle or "by : Someone"
	...
	local UISizeX, UISizeY = unpack(someonelib.Save.UISize)
	...
	local MainScroll = InsertTheme(Create("ScrollingFrame", Components, {
		Size = UDim2.new(0, someonelib.Save.TabSize, 1, -TopBar.Size.Y.Offset),
	...
	ConnectSave(ControlSize1, function()
		if not Minimized then
			someonelib.Save.UISize = {MainFrame.Size.X.Offset, MainFrame.Size.Y.Offset}
			SaveJson("Someone Library.json", someonelib.Save)
		end
	end)
	
	ConnectSave(ControlSize2, function()
		someonelib.Save.TabSize = MainScroll.Size.X.Offset
		SaveJson("someone library.json", someonelib.Save)
	end)
	...
	function Window:MinimizeBtn()
		...
		if Minimized then
			...
			CreateTween({MainFrame, "Size", SaveSize, 1, true})
			...
			CreateTween({MainFrame, "Size", UDim2.fromOffset(MainFrame.Size.X.Offset, 28), 1, true})
			Minimized = true
		end
	...
	function Window:SelectTab(TabSelect)
		if type(TabSelect) == "number" then
			someonelib.Tabs[TabSelect].func:Enable()
		else
			for _,Tab in pairs(someonelib.Tabs) do
	...
	function Window:MakeTab(paste, Configs)
		...
		TIcon = someonelib:GetIcon(TIcon)
		...
		local function Tabs()
			...
			table.foreach(someonelib.Tabs, function(_,Tab)
		...
		FirstTab = true
		local Tab = {}
		table.insert(someonelib.Tabs, {TabInfo = {Name = TName, Icon = TIcon}, func = Tab, Cont = Container})
		Tab.Cont = Container
		...
		function Tab:AddSection(Configs)
			...
			local Section = {}
			table.insert(someonelib.Options, {type = "Section", Name = SectionName, func = Section})
